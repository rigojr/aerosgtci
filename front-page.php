	...
	<div class="wrap-slider">
		<div class="containerS">
			...
			<div class="mySlides item">
					...
					<p class="third-call call-contact-btn center-call"><a class="btn btn-success" href="#">TAKE A LOOK</a></p>
			</div>
			<div class="mySlides item">
					...
					<p class="third-call call-contact-btn left-call"><a class="btn btn-success" href="#">GET MORE INFO!</a></p>
			</div>
		</div>

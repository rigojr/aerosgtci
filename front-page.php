	...
	<div class="wrap-slider">
		<div class="containerS">
			<div class="mySlides item">
					...
					<p class="openF third-call call-contact-btn right-call"><a class="btn btn-success" href="#">BOOK YOURS TODAY</a></p>
			</div>
			<div class="mySlides item">
			...
			<div class="mySlides item">
					...
					<p class="openF third-call call-contact-btn left-call"><a class="btn btn-success" href="#">GET MORE INFO!</a></p>
			</div>
		</div>

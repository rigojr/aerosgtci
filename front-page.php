	...
	<div class="wrap-slider">
		<div class="containerS">
			<div class="mySlides item">
					...
					<p class="third-call call-contact-btn right-call"><a class="btn btn-success openF" href="#">BOOK YOURS TODAY</a></p>
			</div>
			<div class="mySlides item">
					...
					<p class="third-call call-contact-btn center-call"><a class="btn btn-success openF" href="#">TAKE A LOOK</a></p>
			</div>
			<div class="mySlides item">
					<p class="first-call"><b>Upcoming Releases</b></p>
					<p class="second-call"><span>NFC Products, Smart Egary Blind Cane & <b>GlucoAngel</b></span></p>
					<p class="third-call call-contact-btn left-call"><a class="btn btn-success openF" href="#">GET MORE INFO!</a></p>
			</div>
		</div>
